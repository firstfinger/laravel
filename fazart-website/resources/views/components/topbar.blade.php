        ...
        <span class="navbar-toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ml-10">
                    ...
                    <li class="nav-item">
                            <a class="nav-link right" href="#">BLOG</a>
                    </li>
                </ul>

                <div class='product-holder'>
                    <img src="img/yellowsearch.jpg" class='product-image social-img img-fluid'>
                </div>

           </div>

            <a class="navbar-brand mx-auto img-fluid" href="#"><img src="img/logo2.png"/></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <button class="nav-link btn btn-info"> REQUEST A QUOTE </button>
                    </li>
