...
<body>
    ...
    <div class="container">
        <div class="row">
             <div class="col-sm-8">
                   <h4 class>Why Our <span class="db-color"> Agency?</span></h4>
                   ...
                   <P class="font-weight-light"><span class="font-weight-bold ">Fazart Design</span> is all about generate imagination, inspiring design with 'ideas into reality', and also exiciting creation, blessed with creative, innovative and talented imagination. Pan Fareast Studio evoked magical also impressive brilliant ideas with transformative results.</p>
             </div>
    ...
    <div class="container-fluid box">
        <div class="container">
            <div class="card-deck text-justify">
                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-warning"><small class="text-muted">View More>></small></button>
                    </div>
                </div>
                </div>
                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-outline-warning"><small class="text-muted">View More>></small></button>
                    </div>
                </div>
                </div>
                ...
                <div class="card mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-outline-warning mt-4"><small class="text-muted">Vew More>></small></button>
                    </div>
                </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row text-center">
                <div class="col-sm-12 mb-5">
                    ...
                    <button class="btn btn-primary"><i class="fas fa-star"></i> MOST POPULAR</button>
       ...
       <div class="container">
            ...
            <div class="card-deck mt-5">
                    ...
                    <div class="card img-fluid">
                      ...
                      <div class="card-body">
                            <img class="card-img-top" src="img/c21.png" alt="Card image cap">
                      <div class="card-body mt-5">
                            <img class="card-img-top" src="img/c22.png" alt="Card image cap">
                      </div>
                      <div class="card-body">
                            <img class="card-img-top" src="img/c23.png" alt="Card image cap">
                      </div>
                    </div>
                    ...
                    <div class="card img-fluid">
                        ...
                        <div class="card-body">
                            <img class="card-img-top" src="img/c41.png" alt="Card image cap">
                            <img class="card-img-top" src="img/c42.png" alt="Card image cap">
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    ...
                    <div class="col-sm mt-3">
                        <h6 class="text-primary">START YOUR PROJECT</h6>
                    ...
                    <div class="col-sm mt-3">
                        <h6 class="text-primary">ADVERTISING</h6>
                        <div class="small mt-5">
                            <p>Print Design</p>
                            <p>Brochure Design</p>
                    ...
                    <div class="col-sm mt-3">
                        <h6 class="text-primary">OUR COMPANY</h6>
                        <div class="small mt-5">
                            <p>About Us</p>
                            <p>Services</p>
                            <p>Pricing</p>
